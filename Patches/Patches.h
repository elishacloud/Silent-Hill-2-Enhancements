...
typedef enum _CUTSCENEID {
	...
	CUTSCENE_INTRO = 1,
	CUTSCENE_ID_0x03 = 3,
	CUTSCENE_LYING_FIGURE_TUNNEL = 6,
	CUTSCENE_PYRAMID_HEAD_CLOSET = 14,	// 0x0E
	CUTSCENE_ANGELA_MIRROR = 18,		// 0x12
	CUTSCENE_ID_0x15 = 21,				// 0x15
	CUTSCENE_ID_0x16 = 21,				// 0x16
	CUTSCENE_EDDIE_LAURA_BOWLING = 25,	// 0x19
	CUTSCENE_ID_0x24 = 36,				// 0x24
	CUTSCENE_ID_0x2E = 46,				// 0x2E
	CUTSCENE_FINAL_ABSTRACT_DADDY = 68,	// 0x44
	CUTSCENE_LABYRINTH = 70,			// 0x46
	CUTSCENE_ID_0x4C = 76,				// 0x4C
	CUTSCENE_ID_0x4D = 77,				// 0x4D
	CUTSCENE_LAURA_PIANO = 78,			// 0x4E
	CUTSCENE_HOTEL_ROOM_312 = 82,		// 0x52
	CUTSCENE_ID_0x53 = 83,				// 0x53
	CUTSCENE_ID_0x54 = 84,				// 0x54
	CUTSCENE_MARIA_ENDING = 90,			// 0x5A
	CUTSCENE_ID_0x5C = 92,				// 0x5C
	CUTSCENE_LEAVE_ENDING = 93,			// 0x5D
} CUTSCENEID;
