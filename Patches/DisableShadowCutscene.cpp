...
void RunShadowCutscene()
{
	...
	if (GetCutsceneID() == CS_ANGELA_CEMETERY || GetCutsceneID() == CS_HSP_ALT_RADIO_QUIZ || GetCutsceneID() == CS_BOWL_MARIA || GetCutsceneID() == CS_HSP_ALT_LAURA_LEAVES || GetCutsceneID() == CS_END_MARIA_EPILOGUE ||
